    ...
    detail: {
      ...
      sections: [
        ...
        },
        {
          ...
          body:
            "GA4 퍼널을 채널별로 분해하자 '유입량'과 '실제 완료'가 정반대였습니다. 에브리타임은 유입 109명으로 1위지만 단계마다 약 절반씩 빠져 게임 완료는 23명에 그쳤습니다. 반면 링커리어는 유입이 절반(49명)인데 단계 전환율이 높아 완료 31명으로 에브리타임을 앞섰고, 네이버는 게임 시작→완료 전환이 100%였습니다. 세션 참여율도 네이버 86%·링커리어 71% vs 에브리타임 52%로 갈렸습니다. 즉 채널은 방문자 수가 아니라 '단계별 전환과 몰입'으로 평가해야 한다는 결론입니다. ※ 이 채널 수치는 6번에서 발견·수정한 GA4 소스 오염(not set 문제) 이전 데이터라 채널 귀속에 약간의 노이즈가 있을 수 있어, 절대 유입 수보다 채널 간 전환·몰입의 '상대 차이'로 해석했습니다. 수정 후 현재 깨끗한 데이터가 다시 쌓이는 중이며, 분석하는 대로 업데이트할 예정입니다.",
          chart: {
            type: "groupedBar",
        ...
        },
        {
          ...
          body:
            "채널 유입은 단계마다 빠지지만, 한 번이라도 플레이한 사용자는 강하게 고착됐습니다. 행동 로그 5,363건을 분석하니 404개 세션 중 79.2%가 2회 이상 재플레이했고, 세션당 평균 13.3회를 플레이했습니다. 26%는 다른 날 다시 돌아왔고, 66%는 2종 이상의 게임을 시도했습니다. 게임별로는 가장 어려운 N-back이 전체 플레이의 50%로, 사용자들이 '실전에 가까운 어려운 게임'을 가장 많이 연습한다는 신호였습니다. 즉 제품의 고착도는 충분하고, 성장의 병목은 '제품'이 아니라 '첫 플레이까지 데려오는 유입'에 있다는 결론입니다.",
          chart: {
            type: "bar",
    ...
    detail: {
      ...
      sections: [
        ...
        },
        {
          ...
          body:
            "채널과 기기를 교차하자 가설의 전제부터 확인됐습니다. 에브리타임은 모바일 비율 87.9%로 압도적입니다(전체 평균 57%). 그리고 결정적으로, 같은 채널을 PC와 모바일로 쪼개니 재방문율이 극단적으로 갈렸습니다. 에브리타임은 PC 19.2% vs 모바일 5.6%로 약 3.4배, 세션 시간은 12분 12초 vs 2분 24초로 약 5배 차이입니다. 링커리어도 PC 49.4% vs 모바일 38.2%로 같은 방향입니다. 같은 채널·같은 콘텐츠인데 기기로 갈린다는 것은, 사용자 행동의 차이가 아니라 측정 환경의 차이라는 신호입니다.",
          chart: {
            type: "groupedBar",
