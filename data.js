  ...
  /* ============================================================ 08 TRAINER (바이브코딩 MVP) */
  {
    ...
    detail: {
      ...
      data: {
        ...
        scale: "GA4 누적 활성 사용자 18,000+ · 활성 사용자당 평균 참여 1시간 00분 · Supabase 누적 로그 약 7.5만 건 (2026.6.1 배포 후 5주 만에 18,000+ 달성 · 7.9 기준 활성 18,023명 · 누적 신규 17,906명)",
        preprocessing: [],
      },
      metricTabs: {
        title: "GA4 누적 추이 — 배포 후 (2026.6.1 ~ 7.9)",
        ...
        tabs: [
          { key: "누적 신규 사용자", value: "17,900+", unit: "명", data: [18,22,53,100,183,248,302,429,554,668,808,901,951,1011,1091,2026,3159,4083,4669,5528,6442,7138,8078,10458,12236,13115,13494,13783,14338,15225,16129,16692,16947,17099,17265,17442,17583,17716,17906] },
          { key: "누적 이벤트", value: "200만+", unit: "", data: [332,557,1886,3526,7145,11321,16095,22035,33461,42713,52881,62644,66958,71735,78873,108421,187687,285179,367331,511579,657706,760718,923203,1133089,1382476,1484408,1518175,1558599,1615236,1742256,1912632,2030743,2056848,2080780,2102944,2121249,2132548,2145617,2164696] },
        ],
      },
      sections: [
        {
...
from firsts group by 1 order by 1;`,
      ...
      results: [
        "AI 역량검사를 직접 준비하다 느낀 불편을 바이브코딩으로 서비스화 — 게임 4종→9종, 배포 5주 만에 활성 18,000+ (7.9 기준 활성 18,023명)",
