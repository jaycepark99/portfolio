...
for name, model in models.items():   # RF / LR / DT / NB / XGBoost
  ...
  /* ============================================================ 08 TRAINER (바이브코딩 MVP) */
  {
    ...
    summary:
      "Claude Code 바이브코딩으로 AI 역검 게임 연습 사이트를 직접 만들고, GA4·GTM·UTM으로 250+ 사용자를 분석해 채널별 '양 vs 질'을 진단한 뒤 제품 개선으로 잇는 — '만들고 → 측정 → 분석 → 개선' 풀사이클",
    period: "2026.05 ~ (운영 중)",
    type: "개인 프로젝트 · 바이브코딩",
    ...
    detail: {
      ...
      sections: [
        ...
        {
          title: "4. 개선 — 분석을 다시 제품으로",
          body:
            "분석을 제품 개선으로 되돌립니다. ① 에브리타임은 진입 직후 절반이 이탈하는데, '첫 화면이 바로 플레이로 이어지지 않는다'는 가설을 세워 첫 화면에서 즉시 게임이 시작되는 후킹을 개선합니다. ② 링커리어·네이버는 전환·몰입이 높은 고질 채널이므로 콘텐츠·홍보 자원을 집중하고, 일회성 유입인 에브리타임 의존도는 낮춥니다. ③ 퍼널을 '목표 달성'까지 확장해 더 깊은 행동을 측정합니다. 만들고 → 측정 → 분석 → 개선의 사이클을 계속 돌립니다.",
        },
      ],
      resultStats: [
