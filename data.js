      ...
      sections: [
        ...
        },
        {
          ...
          points: [
            ...
            "피드백→공개 루프: 익명 피드백 50건을 받아 수정하고 공개 '최근 개선 사항'('💬 의견 반영')에 남김 — 의견 낸 사람이 반영된 걸 다시 봄 (게임 4종→9종·오답노트도 여기서 나옴)",
...
from firsts group by 1 order by 1;`,
  ...
  /* ============================================================ 09 AIOPS */
  {
    ...
    summary:
      "직접 만들어 운영하는 AI 역량검사 연습 서비스에 응시 상담 질문이 들어오고, 자동 신고 로그에 실제 사용자 의견이 파묻히기 시작했습니다. 반복 질문은 Dify로 RAG 상담봇을 만들어 1차 응대를 맡기고, 쌓인 피드백 123건은 n8n과 Gemini로 자동 분류해 Notion 보드로 만들었습니다 — 자동 감지된 오류 42%와 실제 의견을 나누자 개선 우선순위가 데이터로 드러났습니다.",
    period: "2026.07 ~ (운영 중)",
    ...
    detail: {
      objective:
        "직접 운영하는 서비스의 피드백 창구에 세 가지 신호가 섞여 들어왔습니다 — 사람이 답해줘야 하는 응시 상담 질문, 기기 정보가 붙은 자동 신고 로그, 그리고 그 사이에 파묻힌 진짜 개선 의견. 반복 질문은 AI 상담봇이 1차 응대하게 만들고, 쌓인 피드백은 AI가 자동 분류해 보드로 정리되게 만들어 — '사람이 하던 상담·분류'를 AI 중심으로 재설계한 프로젝트입니다.",
      ...
      sections: [
        {
          ...
          chart: {
            type: "doughnut",
            title: "피드백 123건 유형 분포 — AI 자동 분류 결과",
            labels: ["자동신고 (기기 로그)", "기능요청", "실제 시험과 다름", "버그", "기타", "칭찬", "응시질문"],
            datasets: [{ label: "건수", data: [52, 26, 21, 13, 6, 3, 2] }],
            note: "자동 감지된 오류 42%와 실제 의견 71건(58%)을 나누는 것이 자동화의 첫 성과 — 오류는 원인 분석으로, 의견은 개선 우선순위로.",
          },
        },
        {
          title: "2. AI 상담봇 — FAQ를 지식으로 바꿔 RAG 봇을 라이브에",
        ...
        },
        {
          ...
          points: [
            ...
            "'실제 시험과 다름' 21건 — 재현 정확도 피드백이 꾸준히 들어오는 구조가 서비스 개선(게임 4→9종 확장·규칙 보정)을 이끌어 왔음이 데이터로 확인",
      ...
      results: [
        "AI 상담봇 라이브 배포 — 게임 규칙·연습/실전 사양·실제 응시 환경 질문에 지식 기반 1차 응대",
        "피드백 123건 전수 자동 분류: 자동 감지 오류 52(42%) vs 실제 의견 71(58%) — 오류 신호와 의견을 분리",
