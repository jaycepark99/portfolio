  ...
  /* ============================================================ 08 TRAINER (바이브코딩 MVP) */
  {
    ...
    detail: {
      ...
      data: {
        ...
        scale: "GA4 활성 사용자 5,000+ · 활성당 평균 참여 27분 12초 · Supabase 플레이 로그 5,363건 (2026.6.1 배포 ~ 약 3주, 6.20 기준)",
        preprocessing: [],
      },
      metricTabs: {
        title: "GA4 일별 추이 — 배포 후 (2026.6.1 ~ 6.19)",
        caption: "개인 프로젝트 · 광고 0원 — 6/16 카톡 입소문으로 급증(출처는 09 '측정의 함정' 설문에서 규명), 3주 만에 누적 5,000+.",
...
from firsts group by 1 order by 1;`,
      ...
      results: [
        "AI 역량검사를 직접 준비하다 느낀 불편을 바이브코딩으로 서비스화 — 게임 4종→9종, 배포 약 3주 만에 5,000+ 사용자(6.20 기준)",
