    ...
    detail: {
      ...
      sections: [
        ...
        },
        {
          ...
          callout:
            "🔑 표면 지표 → 기기로 분해 → 측정 방법론 의심 → 진짜 병목(모바일 진입) 발견. 같은 데이터에서 정반대 결론이 나왔습니다. 그리고 이 진단대로 모바일 첫 진입을 개선해, 지금은 모바일이 활성 사용자의 약 45%로 주력이 됐습니다.",
        },
      ],
      resultStats: [
      ...
      results: [
        ...
        "개선 결과: 진단대로 모바일 첫 진입을 손봤고, 지금은 모바일이 활성 사용자의 약 45%(6/23 기준)로 주력이 됨",
      ],
      retro: [
