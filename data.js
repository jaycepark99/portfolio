    ...
    detail: {
      ...
      sections: [
        ...
        },
        {
          ...
          cta: {
            to: "channel-device",
            text: "모바일을 막던 배너를 6/17에 뺐는데 하필 유입도 급등했다 — 전환율 상승이 배너 덕인지 유입 덕인지, 데스크톱을 대조군으로 이중차분해 순효과(+9%p)만 가려낸 분석. 측정의 함정 심층 분석",
          },
        },
        {
...
from firsts group by 1 order by 1;`,
  ...
  },
  {
    ...
    summary:
      "6/17, 모바일을 막던 'PC로 하세요' 배너를 없앴습니다. 그런데 하필 유입이 급등해, 전환율이 올라도 배너 덕인지 유입 덕인지 알 수 없었습니다. 데스크톱을 대조군으로 이중차분(DiD)해 순효과만 +9%p로 갈라낸 분석입니다.",
