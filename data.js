...
for name, model in models.items():   # RF / LR / DT / NB / XGBoost
  ...
  /* ============================================================ 08 TRAINER (바이브코딩 MVP) */
  {
    ...
    metric: { value: "4,000+", label: "멀티채널 활성 사용자 (배포 약 3주 만에)" },
    ...
    detail: {
      ...
      data: {
        ...
        period: "2026.06.01 배포 ~ (운영 중) · 데이터 2026.06.19 기준",
        scale: "GA4 활성 사용자 4,000+(2026.6.1 배포 후 약 3주 만에) · 활성 사용자당 평균 참여 27분 12초 · UTM 멀티채널 (링커리어·에브리타임·네이버·인스타·티스토리) — 6/15~18 하루 1,400명대 급증, 계속 갱신",
        preprocessing: [],
      },
      sections: [
        {
      ...
      resultStats: [
        { value: "4,000+", label: "멀티채널 활성 사용자 (배포 약 3주 만에)" },
        { value: "79%", label: "재플레이율 — 세션당 평균 13회" },
        { value: "+27점", label: "반복 연습 시 점수 향상 (89% 개선)" },
      ],
      results: [
        "AI 역량검사를 직접 준비하다 느낀 불편을 바이브코딩으로 서비스화 — 게임 4종→9종, 배포 약 3주 만에 4,000+ 사용자(6.19 기준)",
