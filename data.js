...
const PRESETS = {
  ...
  freewillin: { label: "전략기획·데이터 의사결정·바이브코딩", featured: "abtest", show: ["trainer", "dashboard", "growth"] },
};
