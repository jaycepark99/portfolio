    ...
    detail: {
      ...
      sections: [
        ...
        },
        {
          ...
          body:
            "측정 신뢰도가 높은 PC 데이터를 기준선으로 삼아 모바일을 보정했습니다. 에브리타임 PC 재방문율 19.2%를 모바일 232명에 적용하면 실제 재방문은 약 45명(GA4 보고 13명)으로, 최대 약 71%가 측정에서 누락됐을 수 있습니다. 다만 PC 사용자는 더 진지한 자기선택 집단이라 일부는 실제 행동 차이일 수 있어, 이 71%는 '측정 손실의 상한 추정'으로 봅니다. 보정 후 채널의 진짜 성격이 드러납니다: 에브리타임은 측정 손실이 큰 '도달·인지' 채널(저질 트래픽이 아님), 링커리어 PC는 신뢰도 높은 최고 가치 채널, 티스토리 PC는 재방문 61.5%로 잠재력이 미실현된 채널입니다.",
          table: {
            sortable: false,
      ...
      results: [
        ...
        "재해석: 에브리타임=도달·인지 채널(저질 아님) / 링커리어 PC=신뢰도 높은 최고 가치 / 티스토리 PC=재방문 61.5% 잠재력",
