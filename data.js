...
from firsts group by 1 order by 1;`,
        ...
        {
          title: "6. '실전보다 쉽다'는 감각을 기준으로 번역 — 실전 문제지와 전수 대조",
      ...
      sections: [
        ...
        },
        {
          ...
          points: [
            ...
            "<b>요구가 정면으로 엇갈릴 때</b>: 길 만들기에서 누구는 '울타리 방향 선택 단계를 없애달라', 누구는 '길까지 표시해달라'고 했다 — 한쪽을 고르면 반대쪽이 이탈하므로 <b>둘을 모드로 갈라</b> 울타리 정답만 보는 쪽과 길까지 보여주는 쪽을 각각 제공해 해결",
