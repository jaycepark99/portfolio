  ...
  /* ============================================================ 08 TRAINER (바이브코딩 MVP) */
  {
    ...
    detail: {
      ...
      data: {
        ...
        scale: "GA4 활성 사용자 5,000+(2026.6.1 배포 후 약 3주 만에) · 활성 사용자당 평균 참여 27분 12초 · UTM 멀티채널 (링커리어·에브리타임·네이버·인스타·티스토리) — 6/15 이후 하루 1,400명대 급증, 계속 갱신",
        preprocessing: [],
      },
      sections: [
        {
