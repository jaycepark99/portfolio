...
for name, model in models.items():   # RF / LR / DT / NB / XGBoost
  ...
  /* ============================================================ 08 TRAINER (바이브코딩 MVP) */
  {
    ...
    summary:
      "공식 체험은 사전 절차가 번거로워 반복 연습이 어려웠습니다. 절차 없이 바로 연습할 사이트를 직접 만들어 배포하고, 만들고 → 측정 → 개선으로 광고 없이 활성 26,000+까지 키웠습니다.",
    period: "2026.05 ~ (운영 중)",
    type: "개인 프로젝트 · 바이브코딩",
...
from firsts group by 1 order by 1;`,
  ...
  },
  {
    ...
    summary:
      "모바일 배너를 없앤 날 하필 유입이 급등해, 전환율이 올라도 배너 덕인지 유입 덕인지 알 수 없었습니다. 데스크톱을 대조군으로 이중차분(DiD)해 순효과만 +9%p로 갈라낸 분석입니다.",
  ...
  /* ============================================================ 09 AIOPS */
  {
    ...
    summary:
      "운영하던 서비스의 피드백 창구에 성격이 다른 신호가 섞였습니다. 오류 로그 52건은 신고 버튼으로 따로 받고, 의견 71건은 n8n·Gemini로 자동 분류해 무엇부터 고칠지를 데이터로 정했습니다.",
    period: "2026.07 ~ (운영 중)",
